    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <motion.div
          ...
          className="absolute top-[5%] right-[-15%] md:right-[-5%] w-[85%] md:w-[50%] max-w-[800px]"
        >
        ...
        <motion.div
          ...
          className="absolute top-[-10%] right-[-5%] md:right-[5%] w-[60%] md:w-[35%] max-w-[600px]"
        >
        ...
        <motion.div
          ...
          className="absolute top-[0%] left-[50%] -translate-x-[50%] w-[90%] md:w-[60%] max-w-[1000px] z-[-1]"
        >
